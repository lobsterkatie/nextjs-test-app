  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        <button>
          <a href="/level-one/other-page">
            Go to /level-one/[param1] where param1 = 'dogs'.
          </a>
        </button>
        {/* <button>
          <a href="/level-one/dogs">
            Go to /level-one/[param1] where param1 = 'dogs'.
          </a>
        </button> */}
        {/* <button>
          <Link href="/level-one/dogs">
            <a>Use a Link to go /level-one/[param1] where param1 = 'dogs'.</a>
          </Link>
        </button> */}
        ...
        {/*         <div>
          <button
            id="message-button"
            onClick={() => outerFunc(messageCallback)}
          >
          ...
          >
            Click me to trigger a promise rejection in an API route outside of
            the handler
          </button>
          ...
          <p>getStaticPaths</p>
          <button>
            <Link href="/boring/getStaticPathsNoError/dogs">
              <a>Use a Link to go to /boring/getStaticPathsNoError/dogs.</a>
            </Link>
          </button>
          <button>
            <a href="/boring/getStaticPathsNoError/dogs">
              Go to /boring/getStaticPathsNoError/dogs.
            </a>
          </button>
          <button>
            <Link href="/boring/getStaticPathsError/dogs">
              <a>Use a Link to go to /boring/getStaticPathsError/dogs.</a>
            </Link>
          </button>
          <button>
            <a href="/boring/getStaticPathsError/dogs">
              Go to /boring/getStaticPathsError/dogs.
            </a>
          </button>

          <p>renderError</p>
          <button>
            <Link href="/boring/renderError">
              <a>Use a Link to go to /boring/renderError.</a>
            </Link>
          </button>
          <button>
            <a href="/boring/renderError">Go to /boring/renderError.</a>
          </button>

          <p>topOfPageError</p>
          <button>
            <Link href="/boring/topOfPageError">
              <a>Use a Link to go to /boring/topOfPageError.</a>
            </Link>
          </button>
          <button>
            <a href="/boring/topOfPageError">Go to /boring/topOfPageError.</a>
          </button>

          <p>Bundle Analysis Graphs</p>
...
//
//   console.log("\nI'm in getStaticProps for the home page.");
//   console.log(context);
//   debugger;
//
...
//   return {
//     props: { color: "blue", propsFrom: "Home.getStaticProps" },
//     revalidate: 1,
//   };
// }
//
